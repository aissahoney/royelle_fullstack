...
const BlogSideBar = () => {
  ...
  useEffect(() => {
    axios.get('http://127.0.0.1:8000/api/articles/')
        .then(res => {
            setTag(res.data.tag)
            console.log('data articles', res.data.tag)
      ...
      <div className="bg-whiteSmoke dark:bg-normalBlack w-full p-4 sm:p-8 2xl:p-10 mt-5 2xl:mt-[30px] rounded-md ">
        ...
        <div className="pt-10">
          <ul className=" " data-aos="fade-up" data-aos-duration="1000">
            ...
            <li key={item.id} className="flex items-center group transition-all duration-300 border-b-[1px] cursor-pointer border-lightGray dark:border-gray pb-3 ">
              <BiChevronsRight
                size={16}
      ...
      <div className="bg-whiteSmoke dark:bg-normalBlack w-full p-4 sm:p-8 2xl:p-10 mt-5 2xl:mt-[30px] rounded-md ">
        ...
        <div className="pt-10 " data-aos="fade-up" data-aos-duration="1000">
          <div className="grid items-center grid-cols-2 md:grid-cols-1 2xl:grid-cols-2 gap-3 sm:gap-5  ">
            {tag && tag.map((item)=>(
            <div key={item.id} className="px-2 sm:px-4 py-2 bg-white dark:bg-lightBlack hover:bg-khaki transition-all duration-300 group">
