...
const About = () => {
  ...
  const [twoRandom, setTwoRandom] = useState([]);
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        console.log("data manager", res.data.manager);
  ...
  const findPersonByName = () => {
    const foundPerson = team.filter(person => person.role == 'Product Manager');
    setMiddle(foundPerson);
  };
  ...
  const handleRandom = () => {
    const filteredTeam = team.filter(person => person.role !== 'Product Manager');
    const random = filteredTeam.sort(() => 0.5 - Math.random()).slice(0, 2);
    setTwoRandom(random);
  };

  console.log("two random", twoRandom);
              ...
              <div className=" w-full grid grid-cols-1 lg:grid-cols-2 items-center ">
                ...
                after main Holisticly facilitate stand-alone inframe */}
                  ...
                  <div className="flex items-center space-x-6 pt-5">
                    <img
                      src={`http://127.0.0.1:8000${item.manager_img}`}
        ...
        <div className="Container">
          ...
          <div className="mt-[60px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[30px] ">
            ...
            {twoRandom ? (
              ...
              >
                <img
                  src={`http://127.0.0.1:8000${twoRandom[0]?.team_image}`}
                  className="w-full"
                  alt=""
                />
            ...
            {middle ? (
              ...
              >
                <img
                  src={`http://127.0.0.1:8000${middle[0]?.team_image}`}
                  className="w-full"
                  alt=""
                />
                <div className="relative">
            ...
            {twoRandom ? (
              ...
              >
                <img
                  src={`http://127.0.0.1:8000${twoRandom[1]?.team_image}`}
                  className="w-full"
                  alt=""
                />
                <div className="relative">
